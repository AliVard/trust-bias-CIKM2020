...
from trust_bias import metrics, common_functions
...
#   flags.DEFINE_string(  'dataset_name', 'MSLR-WEB30k', 
  ...
  flags.DEFINE_list(    'train_query_count_list', [800], 'number of queries used for training and validation')
  
  
  flags.DEFINE_string(  'model_dir', 'clicks/lgbm_20_3.txt', 
  ...
  flags.DEFINE_bool(    'predict', False,
